...
class Footer extends \Opencart\System\Engine\Controller {
	public function index(): string {
		...
		$data['footer_left'] = $this->load->controller('extension/themability4/common/footer_left');
		$data['footer_right'] = $this->load->controller('extension/themability4/common/footer_right');

		return $this->load->view('extension/themability4/common/footer', $data);
