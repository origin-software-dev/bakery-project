...
function db_schema() {
	...
	###  THEMABILITY_TABLES ### 
	$tables[] = [
		'name' => 'themability_blogger',
		'field' => [
			[
				'name' => 'themability_blogger_id',
				'type' => 'int(11)',
				'not_null' => true,
				'auto_increment' => true
			],
	...
	$tables[] = [
		'name' => 'themability_blogger_comment',
		'field' => [
			[
				'name' => 'themability_blogger_comment_id',
				'type' => 'int(11)',
				'not_null' => true,
				'auto_increment' => true
			],
	...
	$tables[] = [
		'name' => 'themability_blogger_comment_description',
		'field' => [
			[
				'name' => 'themability_blogger_comment_id',
				'type' => 'int(11)',
	...
	$tables[] = [
		'name' => 'themability_blogger_description',
		'field' => [
			[
				'name' => 'themability_blogger_id',
				'type' => 'int(11)',
	...
	$tables[] = [
		'name' => 'themability_testimonial',
		'field' => [
			[
				'name' => 'themability_testimonial_id',
				'type' => 'int(11)',
				'not_null' => true,
				'auto_increment' => true,
			],
	...
	$tables[] = [
		'name' => 'themability_testimonial_description',
		'field' => [
			[
				'name' => 'themability_testimonial_id',
				'type' => 'int(11)',
